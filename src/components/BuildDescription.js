...
function BuildDescription() {
        ...
        if ($("#fumble-lost").is(":checked")) {
            ...
            if ($("#attempt-rush").is(":checked")) {
                out += end_poss + " rush for " + $("#yards-gained").val() + " yard" + ($("#yards-gained").val() == 1 ?
                        "" : "s");
                ...
                out += end_poss + " pass for " + $("#yards-gained").val() + " yard" + ($("#yards-gained").val() == 1 ?
                        "" : "s");
                if ($("#offensive-touchdown").is(":checked")) {
                    out += ", TOUCHDOWN!";
                } else if ($("#2pt-conversion").is(":checked")) {
                ...
                out += "Penalty enforced for " + $("#yards-gained").val() + " yard" + ($("#yards-gained").val() == 1 ?
                        "" : "s");
            } else if ($("#attempt-punt").is(":checked")) {
                if ($("#special-teams-touchdown").is(":checked")) {
                    out += start_poss + " punt returned by " + end_poss + " for a TOUCHDOWN!";
                } else {
                ...
                out += start_poss + " is sacked for a loss of " + Math.abs($("#yards-gained").val());
